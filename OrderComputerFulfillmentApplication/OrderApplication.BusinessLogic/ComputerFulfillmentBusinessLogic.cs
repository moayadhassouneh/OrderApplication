...
{
    public class ComputerFulfillmentBusinessLogic : IComputerFulfillmentBusinessLogic
    {
        public void Listen(Action<string> message)
        {
            ...
            var config = new ConsumerConfig()
            {
                ...
                GroupId = Constants.ComputerGroupName,
            ...
            {                
                ...
                while (!cancelled)
                {
                    ...
                    if (consumeResult != null && consumeResult.Message != null)
                    {
                        ...
                        if (orderObj.OrderTypeID == OrderTypeEnums.Computer)
                        {
                            for (int i = 1; i < 4; i++)
                            {
